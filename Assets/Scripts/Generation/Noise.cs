...
namespace Noise
{
    public class NoiseGen
    {
        ...
        public float GetNoise(double x, double y, double z) {
            return octaves > 1 ? Noise.GetOctaveNoise(x * xScale, y * yScale, z * zScale, octaves) : Noise.GetNoise(x * xScale, y * yScale, z * zScale);
        }
    }
    ...
    {
        private static readonly Grad[] _grad3 = {
            new Grad(1, 1, 0), new Grad(-1, 1, 0), new Grad(1, -1, 0), new Grad(-1, -1, 0),
            new Grad(1, 0, 1), new Grad(-1, 0, 1), new Grad(1, 0, -1), new Grad(-1, 0, -1),
            new Grad(0, 1, 1), new Grad(0, -1, 1), new Grad(0, 1, -1), new Grad(0, -1, -1)
        };

        private static readonly short[] _p = {
            ...
            74, 165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 211, 133, 230, 220, 105, 92, 41,
            ...
            119, 248, 152, 2, 44, 154, 163, 70, 221, 153, 101, 155, 167, 43, 172, 9, 129, 22, 39, 253, 19, 98, 108, 110, 79,
        ...
        private static readonly short[] _permMod12 = new short[512];
        ...
        public static float GetOctaveNoise(double pX, double pY, double pZ, int pOctaves) {
            ...
            for (int i = 0; i < pOctaves; i++) {
                float currentHalf = (float)Math.Pow(0.5f, i);
                float currentDouble = (float)Math.Pow(2, i);
